    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'La double authentification est activée. Scannez le QR code ou saisissez la clé de configuration dans votre application d’authentification.',
                buttonText: 'Fermer',
            };
        }
        ...
        return {
            ...
            description:
                'Pour terminer l’activation, scannez le QR code ou saisissez la clé de configuration dans votre application d’authentification',
            buttonText: 'Continuer',
        };
