        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    ...
                    l’accès si vous perdez votre appareil d’authentification.
                            ...
                            <>
                                ...
                                <div className="text-xs text-muted-foreground select-none">
                                    <p id="regenerate-warning">
                                        Chaque code de récupération ne peut
                                        servir qu’une fois et disparaît après
                                        usage. Si vous en avez besoin de
